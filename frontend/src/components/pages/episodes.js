        ...
        <div className="row text-dark bg-white p-5 justify-content-center">
          ...
          <div className="col-12 col-md-6">
            ...
            <p>
              ...
              paradise by leveraging guests’ experiences, knowledge, and
              wisdom.
            </p>
            <div className="all-links">
              ...
              >
                <svg
                  ...
                  height="35"
                  fill="currentColor"
                  class="podcast-vectors img-fluid bi bi-spotify"
                  viewBox="0 0 16 16"
                >
              ...
              >
                <svg
                  ...
                  height="35"
                  fill="currentColor"
                  class="podcast-vectors img-fluid bi bi-apple"
                  viewBox="0 0 16 16"
                >
              ...
              >
                <svg
                  ...
                  height="auto"
                  fill="currentColor"
                  class="podcast-vectors img-fluid bi bi-google"
                  viewBox="0 0 16 16"
                >
              ...
              >
                <svg
                  ...
                  height="auto"
                  fill="currentColor"
                  class="podcast-vectors img-fluid bi bi-youtube"
                  viewBox="0 0 16 16"
                >
